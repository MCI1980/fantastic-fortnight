# capture/guide.py
# Framing guidelines and overlay drawing for video capture
...
def get_recs(angle: Angle) -> Dict[str, Any]:
    """Return framing recommendations for the given angle."""
